...
export default async function CompanyProfilePage({ params }: PageProps) {
  ...
  return (
    <div className="container-app max-w-2xl py-6">
      ...
      <Card className="mb-6">
        <h2 className="mb-3 text-sm font-semibold uppercase text-gray-500">Contact</h2>
        <dl className="space-y-2 text-sm">
          ...
          {entity.complaint_email && (
            <div>
              <dt className="text-gray-500">Complaint Email</dt>
          ...
          {entity.regulator_name && (
            <div>
              <dt className="text-gray-500">Regulator</dt>
              <dd>
